...
def count_down(count):
    ...
    if count > 0:
        ...
        for _ in range(work_session):
            marks += '✓'
        check_mark_title.config(text=marks)
...
check_mark_title = Label(font=(FONT_NAME, 30, 'bold'), bg=YELLOW, fg=GREEN)
check_mark_title.grid(column=1, row=3)
